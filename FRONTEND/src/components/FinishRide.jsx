  ...
  return (
    <>
        <main className='w-full p-5'>
            ...
            <div className="upper-part flex items-center justify-between bg-[#eeee] p-5">
              <div className="flex items-center gap-3">
                ...
                <div className="name-part">
                  <h1 className='font-semibold text-2xl uppercase'>{props.rideData?.user.fullname.firstname + " " + props.rideData?.user.fullname.lastname}</h1>
              ...
              <div className="amount-part">
                <h1 className='font-semibold text-2xl'>${props.rideData?.fare}</h1>
            ...
            <div className="pickup-dropout-location-div p-5">
                <div className="left-right-container flex gap-5 my-5">
                    ...
                    <div className="right-side flex flex-col">
                        ...
                        <h4 className="text-lg font-thin">{props.rideData?.pickup}</h4>
                    </div>
                </div>
                ...
                <div className="left-right-container flex gap-5 my-5">
                    ...
                    <div className="right-side flex flex-col">
                        ...
                        <h4 className="text-lg font-thin">{props.rideData?.destination}</h4>
                    </div>
                </div>
                <div className="line w-full h-[1px] bg-black"></div>
            ...
            <button onClick={endRide} className='flex justify-center font-semibold text-xl uppercase text-white bg-green-500 w-full py-5 rounded-md cursor-pointer active:scale-95 hover:bg-green-600 transition-all'>finish ride</button>
        </main>
    </>
  )
}
