    ...
    <>
      <main className='w-full p-10'>
        ...
        <div className="heading">
          <h2 className='font-semibold text-center text-xl'>Looking for nearby drivers</h2>
          <div className="line-container flex gap-5 mt-5">
        ...
        <div className="vehicle-container relative my-20 mb-40">
          <div className="vehicle-image absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="first-square w-72 h-20 rounded-full bg-blue-100 z-0">
              ...
              <div className="vehicle-image-part w-52 h-34 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ml-3 -mt-2 z-20">
